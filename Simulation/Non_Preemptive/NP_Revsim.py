...
def Simulator(LAM, MU, PHI, revfile):
    ...
    C = ((RHO**2)*PHI)/(MU*(1-RHO)*(1-RHO*(1-PHI))**2) # Cost to make reservation  
    '''
    ...
    class SimEnv:
        ...
        def arrivals(self, env):
            ...
            while True:
                ...
                self.q.push(-1*priority,env.now) 
        ...
        def server(self, env):
            ...
            while True:
                ...
                yield env.timeout(np.random.exponential(1/MU)) # serve customer for some exponential time
